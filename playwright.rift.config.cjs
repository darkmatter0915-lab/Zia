...
module.exports=defineConfig({
 testDir:'./public/rift-forge/tests',testMatch:['art.spec.cjs','mobile.spec.cjs','update.spec.cjs','polish.spec.cjs','encounters.spec.cjs','elements.spec.cjs','progression.spec.cjs','chapter.spec.cjs'],timeout:45000,workers:1,
