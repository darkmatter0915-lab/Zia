...
const paths=['./?release='+release.version,...[...html.matchAll(/(?:src|href)="(\.\/[^\"]+)"/g)].map(m=>m[1]),...Object.values(release.sprites)];
...
console.log(`LIVE_RIFT_ART_VERIFIED ${release.version}: entry, scripts, stylesheet and all five atlases match the release.`);
